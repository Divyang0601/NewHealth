...
@app.route('/quiz_ans',methods = ["POST"])
def result3():
    if request.method == 'POST':
        ...
        #Heart
        temp_value1 = int(request.form['radio7'])
        temp_value1 = temp_value1 + int(request.form['radio8'])
        temp_value1 = temp_value1 + int(request.form['radio9'])
        temp_value1 = temp_value1 + int(request.form['radio10'])

        #malaria
        temp_value2 = int(request.form['radio12'])
        temp_value2 = temp_value2 + int(request.form['radio13'])
        temp_value2 = temp_value2 + int(request.form['radio14'])
        temp_value2 = temp_value2 + int(request.form['radio15'])


        
        if temp_value >= temp_value1 and temp_value >= temp_value2:
            return render_template("cancer_results.html")
        elif temp_value1 >= temp_value and temp_value1 >= temp_value2:
            return render_template("heart_results.html")
        else:
            return render_template("malaria_results.html")
